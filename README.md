...
│   ├── model_evaluation.py   # Metrike i vizuelizacija rezultata
│   ├── model_comparison.py   # Skripta za poređenje više modela
│   └── model_training.py     # Treniranje i čuvanje finalnog modela
│
├── models/
│   └── car_price_model.joblib # Sačuvani trenirani Random Forest model
│
├── requirements.txt           # Zavisnosti (biblioteke)
